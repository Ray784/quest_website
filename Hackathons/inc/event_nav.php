		  ...
		  <div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
			  ...
			  <ul class="nav navbar-nav">
				...
				<li ><a href="index.php">Hackathons</a></li>
				<li class="active"><a href="elaborate.php?url=<?php echo $event['url'];?>"><?php echo $event['title']?></a></li>
				<li><a href="../Workshops/index.php">Workshops</a></li>
				<li><a href="../coords.php">Co-ordinators</a></li>
